export default {
  dashboardLayout: 'px-4 pt-2 pb-0 md:px-10 h-full w-full max-w-[1500px] self-center bg-background-0',
  scrollList: 'max-w-[600px] w-full',
  listItemLayout: 'items-center p-3',
  listItemHeader: 'mb-5 p-3 rounded-xl bg-background-50 justify-between',
