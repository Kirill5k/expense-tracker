<template>
  ...
  >
    ...
    <template v-slot:item.tx="{ item }">
      <v-list-item-content>
        <v-list-item-title v-text="item.tx.name"/>
        <v-list-item-subtitle class="text--secondary font-weight-medium" v-text="item.tx.note"/>
        <v-list-item-subtitle v-text="item.tx.date" class="font-weight-light"/>
      </v-list-item-content>
    </template>
